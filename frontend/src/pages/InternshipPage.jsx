...
import internshipData from '../components/Internship/InternshipData.js'
...
const InternshipPage = () =>{
   ...
   const handleCardClick = (code) =>{
      const foundInternship = internshipData.find(intern => intern.code === code);
    ...
    return(
        ...
        <section className="internships">
          <div className="row">
            {internships.map((intern) => (
              <div key={intern.code} className="col-lg-4 col-md-6 col-sm-12 mb-4">
       ...
       <footer className="text-white text-center py-3">
        <div className="small">
          &copy; 2025 <strong>Dry Pandas Foods</strong>. All rights reserved.
        </div>
      </footer>
